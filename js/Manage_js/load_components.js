async function loadProfileView(containerId = "modal-container") {
    try {
        ...
        const response = await fetch("/Manage_components/Account_manage.html");
...
document.addEventListener("DOMContentLoaded", () => {
    loadComponent("navbar", "Manage_components/navbar.html");
    loadComponent("footer", "Manage_components/footer.html");
});
